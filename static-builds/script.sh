...
cd ~/
rm -rf win64
cp -rf Cmusic/contrib/windeploy ~/sign/win64
cd ~/sign/win64/windeploy
mkdir -p unsigned
mv ~/Cmusic/cmusicai-*setup-unsigned.exe unsigned/
...
cd ~/
rm -rf win32
cp -rf Cmusic/contrib/windeploy ~/sign/win32
...
mkdir -p ~/Cmusic/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/Cmusic/depends/SDKs/MacOSX10.11.sdk.tar.gz
cd ~/Cmusic/depends/SDKs && tar -xf MacOSX10.11.sdk.tar.gz
