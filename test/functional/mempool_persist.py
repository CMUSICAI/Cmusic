...
By default, cmusicaid will dump mempool on shutdown and
...
class MempoolPersistTest(CmusicAITestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give cmusicaid a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent cmusicaid from writing mempool.dat to disk. Verify that `savemempool` fails")
