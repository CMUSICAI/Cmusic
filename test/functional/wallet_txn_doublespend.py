...
class TxnMallTest(CmusicAITestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 cmusicai:
        ...
        # First: use raw transaction API to send 1240 cmusicai to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 cmusicai coin each
        ...
        # Node0's balance should be starting balance, plus 50cmusicai for another
        ...
        # Node0's total balance should be starting balance, plus 100cmusicai for 
