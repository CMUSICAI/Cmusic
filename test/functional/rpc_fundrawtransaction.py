...
class RawTransactionsTest(CmusicAITestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-5, "changeAddress must be a valid cmusicai address", self.nodes[2].fundrawtransaction, rawtx, {'changeAddress':'foobar'})
        ...
        # send 1.2 cmusicai to msig addr
