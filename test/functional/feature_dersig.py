...
class BIP66Test(CmusicAITestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # cmusicaid is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and cmusicaid produces more specific reject
            # reasons.
