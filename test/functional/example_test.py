...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the CmusicAITestFramework
    pass

class ExampleTest(CmusicAITestFramework):
    # Each functional test is a subclass of the CmusicAITestFramework class.
    ...
    def custom_method(self):
        ...
        CmusicAITestFramework class so other tests can use it."""
