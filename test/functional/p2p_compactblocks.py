...
# TestNode: A peer we use to send messages to cmusicaid, and store responses.
...
class CompactBlocksTest(CmusicAITestFramework):
    ...
    # This test actually causes cmusicaid to (reasonably!) disconnect us, so do this last.
    ...
    # Test that cmusicaid requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for cmusicaid to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # cmusicaid will not send blocktxn responses for blocks whose height is
