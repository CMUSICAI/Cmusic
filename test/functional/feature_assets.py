...
class AssetTest(CmusicAITestFramework):
    ...
    def big_test(self):
        ...
        n0.issue("CMUSICAI1", 1000)
        n0.issue("CMUSICAI2", 1000)
        n0.issue("CMUSICAI3", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="CMS*", verbose=False, count=2, start=-2)
        ...
        cmusicai_assets = n0.listassets(asset="CMS*", verbose=False, count=2, start=-2)
        assert_equal(len(cmusicai_assets), 2)
        assert_equal(cmusicai_assets[0], "CMUSICAI2")
        assert_equal(cmusicai_assets[1], "CMUSICAI3")
        self.sync_all()
