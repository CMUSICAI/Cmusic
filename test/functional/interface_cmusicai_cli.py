...
class TestCmusicAICli(CmusicAITestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `cmusicai-cli getinfo`")
        ...
        self.log.info("Compare responses from `cmusicai-cli -getinfo` and the RPCs data is retrieved from.")
