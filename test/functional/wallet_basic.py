...
class WalletTest(CmusicAITestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 cmusicai from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 cmusicai with subtract fee from amount
        ...
        # Sendmany 10 cmusicai with subtract fee from amount
