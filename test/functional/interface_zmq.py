...
import os
import struct
from test_framework.test_framework import CmusicAITestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest(CmusicAITestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that cmusicai has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("cmusicaid has not been built with zmq enabled.")
