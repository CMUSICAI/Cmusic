 ...
 */
#ifndef CMUSICAI_UTIL_H
#define CMUSICAI_UTIL_H
...
extern const char *const CMUSICAI_CONF_FILENAME;
extern const char *const CMUSICAI_PID_FILENAME;
...
{
    std::string s = strprintf("cmusicai-%s", name);
