...
#ifndef CMUSICAI_RPCSERVER_H
#define CMUSICAI_RPCSERVER_H
...
/**
 * CmusicAI RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern CAmount AmountFromValue(const UniValue& value, bool p_iscmusicai = true);
