...
CAmount AmountFromValue(const UniValue& value, bool p_iscmusicai)
{
    ...
    if (p_iscmusicai && !MoneyRange(amount))
...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    return "CmusicAI server stopping";
}
...
{
    return "> cmusicai-cli " + methodname + " " + args + "\n";
}
