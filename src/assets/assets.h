...
#ifndef CMUSICAICOIN_ASSET_PROTOCOL_H
#define CMUSICAICOIN_ASSET_PROTOCOL_H
...
#define cmusicai_N 114
#define cmusicai_E 118
#define cmusicai_X 110
#define cmusicai_Q 113
#define cmusicai_T 116
#define cmusicai_O 111
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_CMUSICAI_ASSET cmusicaiQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_CMUSICAI_ASSET cmusicaiO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_CMUSICAI_ASSET cmusicaiR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_CMUSICAI_ASSET cmusicaiT
...
#endif //CMUSICAICOIN_ASSET_PROTOCOL_H
