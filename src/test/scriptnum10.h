...
#ifndef CMUSICAI_TEST_SCRIPTNUM10_H
#define CMUSICAI_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from CmusicAI Core 0.10.0, for cross-comparison.
 */
public:
