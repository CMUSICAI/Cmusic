...
#ifndef CMUSICAI_SCRIPT_STANDARD_H
#define CMUSICAI_SCRIPT_STANDARD_H
...
enum txnouttype
{
    ...
    TX_RESTRICTED_ASSET_DATA = 11, //!< unspendable OP_CMUSICAI_ASSET script that carries data
    /** CMS END */
};
 ...
 *  A CTxDestination is the internal data type encoded in a cmusicai address
 */
...
/**
 * Generate a CmusicAI scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // CMUSICAI_SCRIPT_STANDARD_H
