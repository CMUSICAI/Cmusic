...
#ifndef CMUSICAI_SCRIPT_SCRIPT_H
#define CMUSICAI_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, CmusicAI always counted CHECKMULTISIGs
...
#endif // CMUSICAI_SCRIPT_SCRIPT_H
