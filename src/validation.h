...
#ifndef CMUSICAI_VALIDATION_H
#define CMUSICAI_VALIDATION_H
...
/** Block download timeout base, expressed in millionths of the block interval (i.e. 10 min) */ // TODO Should we change this for cmusicai, with 1 minutes block intervals?
