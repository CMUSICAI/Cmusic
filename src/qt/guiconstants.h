...
#ifndef CMUSICAI_QT_GUICONSTANTS_H
#define CMUSICAI_QT_GUICONSTANTS_H
...
/* CmusicAIGUI -- Size of icons in status bar */
...
/* CmusicAI dark orange */
#define COLOR_DARK_ORANGE QColor("#f05239")
/* CmusicAI light orange */
...
/* CmusicAI shadow color - light mode */
...
/* CmusicAI label color as a string */
...
#define QAPP_ORG_NAME "CmusicAI"
#define QAPP_ORG_DOMAIN "cmusicai.org"
#define QAPP_APP_NAME_DEFAULT "CmusicAI-Qt"
#define QAPP_APP_NAME_TESTNET "CmusicAI-Qt-testnet"

#endif // CMUSICAI_QT_GUICONSTANTS_H
