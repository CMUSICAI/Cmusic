...
void WalletView::setCmusicAIGUI(CmusicAIGUI *gui)
{
    if (gui)
    {
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    if (_walletModel)
    {
        ...
        // update HD status
        Q_EMIT hdEnabledStatusChanged(_walletModel->hd44Enabled() ? CmusicAIGUI::HD44_ENABLED : _walletModel->hdEnabled() ? CmusicAIGUI::HD_ENABLED : CmusicAIGUI::HD_DISABLED);
