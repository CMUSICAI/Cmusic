...
#ifndef CMUSICAI_QT_GUIUTIL_H
#define CMUSICAI_QT_GUIUTIL_H
...
/** Utility functions used by the cmusicai Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "cmusicai:" URI into recipient object, return true on successful parsing
