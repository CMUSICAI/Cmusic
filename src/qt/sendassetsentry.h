...
#ifndef CMUSICAI_QT_SENDASSETSENTRY_H
#define CMUSICAI_QT_SENDASSETSENTRY_H
...
/**
 * A single entry in the dialog for sending cmusicai.
...
#endif // CMUSICAI_QT_SENDASSETSENTRY_H
