...
int main(int argc, char *argv[])
{
    ...
    noui_connect();
    ClearDatadirCache();
    fs::path pathTemp = fs::temp_directory_path() / strprintf("test_cmusicai-qt_%lu_%i", (unsigned long) GetTime(), (int) GetRand(100000));
    ...
    app.setApplicationName("CmusicAI-Qt-test");
