...
#include "qt/cmusicaiamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<CmusicAIAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_cmusicai-qt -platform xcb      # Linux
//     src/qt/test/test_cmusicai-qt -platform windows  # Windows
//     src/qt/test/test_cmusicai-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = CmusicAIUnits::formatWithUnit(unit, balance, false, CmusicAIUnits::separatorAlways);
    ...
    // Amount input
    CmusicAIAmountField* amountInput = receiveCoinsDialog.findChild<CmusicAIAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: cmusicai:")) != -1);
