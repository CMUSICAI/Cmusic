...
#include "config/cmusicai-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatCmusicAIURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + CmusicAIUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatCmusicAIURI(info));
}
