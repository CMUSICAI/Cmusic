...
#ifndef CMUSICAI_QT_CMUSICAIUNITS_H
#define CMUSICAI_QT_CMUSICAIUNITS_H
...
/** cmusicai unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class CmusicAIUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit CmusicAIUnits(QObject *parent);
...
typedef CmusicAIUnits::Unit CmusicAIUnit;

#endif // CMUSICAI_QT_CMUSICAIUNITS_H
