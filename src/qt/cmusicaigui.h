...
#ifndef CMUSICAI_QT_CmusicAIGUI_H
#define CMUSICAI_QT_CmusicAIGUI_H
...
/**
  cmusicai GUI main class. This class represents the main window of the cmusicai UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class CmusicAIGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit CmusicAIGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~CmusicAIGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a cmusicai wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
#endif // CMUSICAI_QT_CmusicAIGUI_H
