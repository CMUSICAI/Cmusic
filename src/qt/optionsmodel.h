...
#ifndef CMUSICAI_QT_OPTIONSMODEL_H
#define CMUSICAI_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for cmusicai client.
...
public:
    ...
    enum OptionID {
        ...
        ProxyIPTor,             // QString
        ProxyPortTor,           // int
        DisplayUnit,            // CmusicAIUnits::Unit
...
#endif // CMUSICAI_QT_OPTIONSMODEL_H
