...
#ifndef CMUSICAI_QT_RECEIVECOINSDIALOG_H
#define CMUSICAI_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of cmusicai */
...
#endif // CMUSICAI_QT_RECEIVECOINSDIALOG_H
