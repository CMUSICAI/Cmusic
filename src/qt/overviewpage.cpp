...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(CmusicAIUnits::cmusicai),
    ...
    assetdelegate(new AssetViewDelegate(platformStyle, this))
{
    ...
    ui->cmusicaiBalancesLabel->setStyleSheet(STRING_LABEL_COLOR);
    ...
    ui->cmusicaiBalancesLabel->setFont(GUIUtil::getTopLabelFont());
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(CmusicAIUnits::formatWithUnit(unit, balance, false, CmusicAIUnits::separatorAlways));
    ui->labelUnconfirmed->setText(CmusicAIUnits::formatWithUnit(unit, unconfirmedBalance, false, CmusicAIUnits::separatorAlways));
    ui->labelImmature->setText(CmusicAIUnits::formatWithUnit(unit, immatureBalance, false, CmusicAIUnits::separatorAlways));
    ui->labelTotal->setText(CmusicAIUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, CmusicAIUnits::separatorAlways));
    ui->labelWatchAvailable->setText(CmusicAIUnits::formatWithUnit(unit, watchOnlyBalance, false, CmusicAIUnits::separatorAlways));
    ui->labelWatchPending->setText(CmusicAIUnits::formatWithUnit(unit, watchUnconfBalance, false, CmusicAIUnits::separatorAlways));
    ui->labelWatchImmature->setText(CmusicAIUnits::formatWithUnit(unit, watchImmatureBalance, false, CmusicAIUnits::separatorAlways));
    ui->labelWatchTotal->setText(CmusicAIUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, CmusicAIUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("cmusicai")
    updateDisplayUnit();
}
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the cmusicai balance grid from expanding and looking terrible when asset balance is hidden
