...
Below are some notes on how to build CmusicAI Core for Windows.
...
way. This will install to `c:\workspace\cmusicai`, for example:

    make install DESTDIR=/mnt/c/workspace/cmusicai
