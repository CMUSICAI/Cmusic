CmusicAI Core version *2.2.2* is now available!!
==============

  <https://github.com/CMUSICAIProject/CMUSICAIcoin/releases/tag/v2.2.2>
...
- Enhancements for CMUSICAIcoin Dev Kit and Mobile Wallet Support
...
Changelog available here: <https://github.com/CMUSICAIProject/CMUSICAIcoin/commits/release_2.2.2>
