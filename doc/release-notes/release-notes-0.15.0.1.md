CmusicAI Core version *0.15.0.1* is now available from:

  <https://cmusicai.org/bin/cmusicai-core-0.15.0.1/>

and

  <https://cmusicaicoin.org/bin/cmusicai-core-0.15.0.1/>
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/cmusicai/).
