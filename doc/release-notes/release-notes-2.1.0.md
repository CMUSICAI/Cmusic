CmusicAI Core version *2.1.0* is now available!!
==============

  <https://github.com/CMUSICAIProject/CMUSICAIcoin/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/CMUSICAIProject/CMUSICAIcoin/commits/release_2.1.0>
