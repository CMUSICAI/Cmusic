...
if [[ ${OS} == "windows" ]]; then
    ...
    if [[ -e ${GITHUB_WORKSPACE}/dist/CmusicAI-Qt.app/Contents/MacOS/install_cli.sh ]]; then
        chmod +x ${GITHUB_WORKSPACE}/dist/CmusicAI-Qt.app/Contents/MacOS/install_cli.sh
    fi
