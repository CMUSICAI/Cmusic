## CmusicAI Metadata Specification

Additional fields may be added, but will be ignored by CmusicAI.
...
```
{
   ...
   "contract_signature": "<CmusicAI signed contract_hash>",
